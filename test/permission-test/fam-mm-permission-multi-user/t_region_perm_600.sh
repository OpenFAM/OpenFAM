...
# As user1:user1 Create a region with permission 600 of size 100MB
su -c "./fam_create_region myRegion  100 600" user1 || test_failed "Create Region failed: $?" 1
...
! su -c "./fam_changepermission_region myRegion 666" user2 2>&1 1>/dev/null 2>/dev/null || test_failed "Change Region permission user2 expected to fail: $?"
...
! su -c "./fam_changepermission_region myRegion 666" user3 2>&1 1>/dev/null 2>/dev/null || test_failed "Change Region permission user3 expected to fail: $?"
