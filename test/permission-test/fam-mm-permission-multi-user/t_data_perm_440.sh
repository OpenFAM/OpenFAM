...
#"R R --"	1001	1001	1001	1001	-	NA	-	✔	NA	✔	NA	✔	✔	✔
#				1002	1001	-	NA	-	✖ 	NA	✖ 	NA	✔	✔	✖ 
#				1003	1001	-	NA	-	✖ 	NA	✖ 	NA     	✔	✔       ✖ 
#				1004	1004	-	NA	-	✖ 	NA	✖ 	NA	✔	✖	✖ 
...
# As user1:user1 Create a region with permission 440 of size 100MB
...
! su -c "./fam_changepermission_data myRegion myData 660" user2 2>&1 1>/dev/null || test_failed "Write DataItem user2 expected to fail: $?"
...
#! su -c "./fam_changepermission_data myRegion myData 660" user3 2>&1 1>/dev/null || test_failed "Write DataItem user3 expected to fail: $?"
...
! su -c "./fam_changepermission_data myRegion myData 660" user4 2>&1 1>/dev/null || test_failed "Write DataItem user4 expected to fail: $?"
