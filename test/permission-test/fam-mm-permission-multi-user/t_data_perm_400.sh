...
echo "Tests DataItem APIs with 000 permission"

#Perm		uid	gid	operuid	opergid	CR	DR	ADi	DDi	CRP	CDiP	RL	DL	Put	Get
#"-- -- --"	1001	1001	1001	1001	-	NA	-	✔	NA	✔	NA	✔	✔	✔
#				1002	1001	-	NA	-	✖ 	NA	✖ 	NA	✖ 	✖ 	✖ 
#				1003	1001	-	NA	-	✖ 	NA	✖ 	NA	✖ 	✖ 	✖ 
#				1004	1004	-	NA	-	✖ 	NA	✖ 	NA	✖ 	✖ 	✖ 
...
su -c "./fam_allocate_data myRegion myData 50 400" user1 || test_failed "Allocate DataItem user1 failed: $?"
...
! su -c "./fam_lookup_data myRegion myData" user2 2>&1 1>/dev/null || test_failed "Lookup DataItem user2 expected to fail: $?"

# As user2 : Read DataItem
! su -c "./fam_get_data myRegion myData 0 13" user2 2>&1 1>/dev/null || test_failed "Read DataItem user2 expected to fail: $?"

# As user2 : Write DataItem
! su -c "./fam_put_data myRegion myData 0 13 welcome" user2 2>&1 1>/dev/null || test_failed "Write DataItem user2 expected to fail: $?"

#Tests which fails.Need to be addressed.
# As user2 : Change DataItem Permission
#! su -c "./fam_changepermission_data myRegion myData 400" user2 2>&1 1>/dev/null || test_failed "Write DataItem user2 expected to fail: $?"

# As user2 : Deallocate DataItem
! su -c "./fam_deallocate_data myRegion myData" user2 || test_failed "Deallocate DataItem user2 expected to fail: $?"

#Tests which fails.Need to be addressed.
# As user3 : Lookup DataItem
#! su -c "./fam_lookup_data myRegion myData" user3 2>&1 1>/dev/null || test_failed "Lookup DataItem user3 expected to fail: $?"

# As user3 : Read DataItem
#! su -c "./fam_get_data myRegion myData 0 13" user3 2>&1 1>/dev/null || test_failed "Read DataItem user3 expected to fail: $?"

# As user3 : Write DataItem
#! su -c "./fam_put_data myRegion myData 0 13 welcome" user3 2>&1 1>/dev/null || test_failed "Write DataItem user3 expected to fail: $?"

# As user3 : Change DataItem Permission
#! su -c "./fam_changepermission_data myRegion myData 400" user3 2>&1 1>/dev/null || test_failed "Write DataItem user3 expected to fail: $?"

# As user3 : Deallocate DataItem
#! su -c "./fam_deallocate_data myRegion myData" user3 || test_failed "Deallocate DataItem user3 expected to fail: $?"
...
#! su -c "./fam_changepermission_data myRegion myData 400" user4 2>&1 1>/dev/null || test_failed "Write DataItem user4 expected to fail: $?"
